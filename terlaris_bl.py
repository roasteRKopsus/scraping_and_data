...
site = "https://www.bukalapak.com/products?utf8=%E2%9C%93&search%5Bkeywords%5D=kopi+arabika&search%5Bsort_by%5D=weekly_sales_ratio%3Adesc"
...
productprice_terlaris = [productprice.find(class_='amount positive').get_text() for productprice in product_row]
...
#print(productrating)
#print(productrating)
value_count = range(len(productprice_terlaris))
#print(product_row)
